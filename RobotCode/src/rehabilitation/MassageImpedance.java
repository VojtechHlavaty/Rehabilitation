...
public class MassageImpedance extends RoboticsAPIApplication {
private LBR lbr;
...
private final static String informationText=
    ...
    public void run() {
        ...
        IMotionContainer traj = lbr.moveAsync(ptpvia1);
        traj.append(ptpvia2);
        traj.append(ptpvia3);
        traj.append(ptpvia4);
        traj.append(ptpvia5);
        ...
        traj.append(ptpvia8);
        traj.append(ptpvia9);
        traj.append(ptpvia10);
        traj.append(ptpvia11);
        traj.append(ptpvia12);
